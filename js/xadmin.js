;!function (win) {
  ...
  Xadmin.prototype.end = function() {
	...
	Xadmin.prototype.add_tab = function (title,url,is_refresh) {
	    ...
	    if (url === null || url === '' || url === 'javascript:;') {
	        var url="index.php?p=404";
	    };
    ...
    $('.left-nav #nav').on('click', 'li', function(event) {
        ...
        if($(this).children('.sub-menu').length){
            if($(this).hasClass('open')){
                ...
                if($(this).children('.sub-menu').children('li').hasClass('open')){
                    //解决点击本级的一级菜单子菜单不收缩的问题
                    $(this).children('.sub-menu').children('li').removeClass('open');
                    $(this).children('.sub-menu').children('li').children('.sub-menu').stop(true,true).slideUp();
                }
            }else{
                $(this).addClass('open');
                ...
                if($(this).siblings().children('.sub-menu').children('li').hasClass('open')){
                    //解决点击其他一级菜单子菜单收缩的问题
                    $(this).siblings().children('.sub-menu').children('li').removeClass('open');
                    $(this).siblings().children('.sub-menu').children('li').children('.sub-menu').stop(true,true).slideUp();
                }
            }
        }
